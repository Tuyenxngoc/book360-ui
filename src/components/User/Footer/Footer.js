            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-3">
                        ...
                        <label htmlFor="emailInput" className={cx('item')}>Đăng ký nhận thông tin tại đây</label>
                        <div className={cx('form-group')}>
                            <input
                                ...
                                autoComplete="email"
                            />
                            <Button variant="contained" size="small" sx={{ minWidth: '120px', ml: 2 }}>Đăng ký</Button>
                        </div>
                    </div>
                </div></div>

                ...
                <div className="col-10">
                    <div className={cx('order-list-main')}>
                        <div className={cx('order-list-tab')}>
                            <Tabs activeKey={type} items={billStatus} onChange={handleChangeOrderStatus} size="large" />
                        </div>
                                ...
                                <div className="col-12">
                                    <div className={cx('date-range-picker')}>
                                        ...
                                        <RangePicker
                                            ...
                                            defaultValue={[
                                                dayjs(defaultDateRange.start, dateFormat),
                                                dayjs(defaultDateRange.end, dateFormat),
                                            ]}
                                            format={dateFormat}
                                        />
                                        <Button
